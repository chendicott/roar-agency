...
class TripForm extends Component
{
    ...
    private function participantDetailRules() {
        ...
        for ($i = 1; $i <= $this->numberOfParticipants; $i++) {
            ...
            if (isset($this->participant[$i]['planManaged']) && $this->participant[$i]['planManaged'] === 'Yes') {
                $rules["participant.{$i}.planManagerEmail"] = 'required|email';
    ...
    private function tripDetailsRules() {
        $rules = [
            ...
            'tripAccommodationProvider' => 'required',
            'tripStartDate' => 'required',
            'tripEndDate' => 'required',
            'tripSupportWorkerFirstName' => 'required',
            'tripSupportWorkerLastName' => 'required',
            'tripSupportWorkerEmail' => 'required|email',
            'tripSupportWorkerContact' => 'required',
    ...
    public function submit() {
        ...
        try {
            ...
            foreach ($participantsWithUniqueEmails as $participant) {
                ...
                $participantAsUser->medicalDetails()->create($participant['medicalDetails']);
