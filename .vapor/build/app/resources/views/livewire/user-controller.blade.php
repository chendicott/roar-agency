                    ...
                    @if (!$isEditing)
                        ...
                        <div class="py-6 border-b border-gray-200 px-5">
                            <div class="flex">
                                ...
                                <div class="flex flex-col">
                                    <div class="text-sm text-gray-900">@if (isset($user->details['dateOfBirth'])) {{$user->details['dateOfBirth']}} @endif</div>
                                </div>
                            </div>
                        </div>
                ...
                @if ($currentUserIsAdmin)
                    <div x-show="tab === 'Trips'">
                        <div class="pt-6 pb-6 border-b border-gray-200">
                            ...
                            <h4 class="text base font-medium mt-10">Trips as a Participant</h4>
                            <div class="text-sm font-medium text-gray-500 mt-1">
                                All trips for this profile as a participant are displayed below
                            </div>
{{--                            @foreach ($user->tripsAsParticipant as $trip)--}}
{{--                                {{$trip}}--}}
{{--                            @endforeach--}}

                            @if ($user->tripsAsParticipant->count() === 0)
                                <div class="text-sm text-gray-500 mt-3">
                                    No trips found
                                </div>
                            @endif

                            <h4 class="text base font-medium mt-10">Trips as a Support Worker</h4>
                            <div class="text-sm font-medium text-gray-500 mt-1">
                                All trips for this profile as a support worker are displayed below
                            </div>
{{--                            @foreach ($user->tripsAsSupportWorker as $trip)--}}
{{--                                {{$trip}}--}}
{{--                            @endforeach--}}

                            @if ($user->tripsAsSupportWorker->count() === 0)
                                <div class="text-sm text-gray-500 mt-3">
                                    No trips found
                                </div>
                            @endif
