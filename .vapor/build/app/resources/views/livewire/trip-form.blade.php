                    ...
                    @if ($currentStep == 'trip-details')
                        <div class="w-4/6 px-3">
                            ...
                            <div class="border-b pb-4 border-gray-200">
                                ...
                                <div class="block pb-4 w-full">
                                    <x-label>Do you have dates in mind for the trip?</x-label>
                                    <div class="flex flex-col mt-2">
                                        <label>
                                            <input type="radio" wire:model.lazy="tripDatesKnown"
                                                   value="Yes">
                                            Yes
                                        </label>
                                        <label>
                                        ...
                                        <x-input-error for="tripDatesKnown"/>
                                    </div>
                                </div>

                                @if ($tripDatesKnown == 'Yes')
